            ...
            <div className="firstText">
                <div className="container" >
                    ...
                    <div className="holder">
                        ...
                        to <a href={window.location.origin + "/contact"}   target="_blank">Contact Us</a> and may be seen throughout other websites on the Internet.
                    ...
                    <div className="holder">
                        ...
                        <a href="https://mail.google.com/mail/?view=cm&fs=1&tf=1&to=info.doyenify@gmail.com" style={{marginLeft: "5px"}} target="_blank">info.doyenify@gmail.com</a></div>
                    </div>
