      ...
      <Modal show={isShow}>
                ...
                <Modal.Body>
                    <div className="row" style={{textAlign: "justify"}} >
                        ...
                        <br/>
                        <div className="text-center">
                             Doyenify provides IT and Consultancy  (Services) via the Company website offered from time to time reach Us through <a href={window.location.pathname + "contact"}>Our Contact Form</a> .  The Company Service is owned and operated by Doyenify Team Members.
